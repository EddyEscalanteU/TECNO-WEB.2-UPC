...
import { ACTIVIDAD5Component } from '@monorepo-upc/ACTIVIDAD_5';

@Component({
  standalone: true,
  imports: [NxWelcomeComponent, RouterModule, MegaMenuComponent, FilterTableComponent, CommonModule, Pagina1Component, ACTIVIDAD5Component],
