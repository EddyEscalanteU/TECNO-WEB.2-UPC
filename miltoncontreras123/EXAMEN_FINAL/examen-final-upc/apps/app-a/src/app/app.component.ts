...
import { CurtainMenuComponent } from '@examen-final-upc/curtain_menu';
...
@Component({
  standalone: true,
  imports: [NxWelcomeComponent, RouterModule, CurtainMenuComponent, FilterListsComponent, FilterTableComponent, CardViewVerticalComponent],
