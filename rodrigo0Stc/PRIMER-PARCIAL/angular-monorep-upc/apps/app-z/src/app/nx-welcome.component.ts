...
import { CurtComponent } from '@angular-monorep-upc/curt';

@Component({
  selector: 'angular-monorep-upc-nx-welcome',
  standalone: true,
  imports: [CommonModule, CurtComponent],
  template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div id="welcome">
          ...
          <angular-monorep-upc-curt></angular-monorep-upc-curt>
        </div>
        <!--  HERO  -->
