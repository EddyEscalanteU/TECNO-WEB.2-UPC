      ...
      <div class="container">
        ...
        <div id="middle-content">
          ...
          <div id="learning-materials" class="rounded shadow">
            <h2>Photos con Imagenes</h2>
            <div *ngFor="let item of listadoPhotos">
              <a rel="noreferrer"
  ...
  public WebServiceGetPhotos() {
    this.photosService.GetPhotos()
      .subscribe(data => {
        ...
        this.listadoPhotos = data;
        console.log("this.listadoPhotos:", this.listadoPhotos);
      })
